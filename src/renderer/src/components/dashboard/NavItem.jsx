...
const NavItem = memo(({ item, isSidebarOpen, activeTab, setActiveTab }) => {
  ...
  const buttonClass = `flex mb-2 items-center w-full p-4 rounded-lg cursor hover:transition-all duration-300 ease-in-out hover:shadow-custom-hover hover:border-inner-white
    ${
      activeTab === item.id
